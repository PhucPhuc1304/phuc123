            ...
            <form action="login.php"  method="post">            
                <div class="modal-body">
                    <div class="modal-login">
                        ...
                        <input class="form-control" type="text" id = "user" name="user"placeholder="Tên đăng nhập hoặc email">
                        </div>
                        <div class="modal-password login">
                        <i class="ti ti-lock"></i>
                        <input class="form-control" type="password" id = "pass" name="pass" placeholder="Mật khẩu">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="modal-login-button">
                    <button id="submit_login" value="dang nhap" name = "submit_login">LOGIN</button>
                    </div>
                </div>
            </form>
